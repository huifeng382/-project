...
| v2nowaver42m4 | 纯拓扑 × rank 直训（RANK_LOSS_W=0.5, 17.0.4 空格2） | 训完🔜Rust | 25.29% | **2.91%** | 87.4% | —（待 shadow） | — | — |
| v2iagr42m4 | GBDT15 × rank 直训（RANK_LOSS_W=0.5, 17.0.4 空格1） | 训完🔜Rust | 25.65% | **2.85%** | 87.2% | —（待 shadow） | — | — |
